...
<body>
    ...
    <div class="container py-4">
        <div class="d-flex align-items-center gap-3 mb-3">
            <i class="fa-solid fa-images fa-2x text-primary"></i>
            <div>
                <h1 class="h4 mb-1">Catalogue — Gestion d'images produit</h1>
                <p class="text-muted mb-0">Drag & drop, multi-upload, et prévisualisations</p>
            </div>
        </div>
