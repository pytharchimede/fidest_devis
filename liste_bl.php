...
<body class="module-page delivery-page">
    <?php include __DIR__ . '/partials/navbar.php'; ?>
    <div class="container py-4">
        <div class="page-title mb-4">
            <div class="module-heading__copy">
                <span class="module-heading__icon"><i class="fas fa-truck-fast"></i></span>
                <div><h1 class="m-0">Bons de livraison</h1><p class="mb-0 text-muted">Suivez les documents à signer et les livraisons finalisées.</p></div>
            </div>
