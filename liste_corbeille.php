...
<body class="module-page trash-page">
    <?php include __DIR__ . '/partials/navbar.php'; ?>
    <div class="container py-4">
        <div class="module-heading">
            <div class="module-heading__copy">
                <span class="module-heading__icon"><i class="fas fa-trash-restore"></i></span>
                <div><h1>Corbeille</h1><p>Consultez et restaurez les devis précédemment supprimés.</p></div>
            </div>
        </div>
        <?php
